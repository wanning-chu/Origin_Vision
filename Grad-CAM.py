...
def get_params():
    ...
    params = {
        ...
        # "cfg": "D:/deeplearning/PycharmProjects/copy_yolov8/ultralytics/cfg/models/v8/snu77/yolov8n-fasternet-mlca-siou-carafe.yaml",
...
#         'cfg': r"D:\deeplearning\PycharmProjects\copy_yolov8\ultralytics\cfg\models\v8\snu77\yolov8n-fasternet-mlca-siou-carafe.yaml",  # 训练权重对应的yaml配置文件
#         "device": "cpu",
